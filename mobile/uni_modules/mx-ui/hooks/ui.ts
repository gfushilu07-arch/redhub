...
export type UiInstance = {
	 ...
	 */
	showConfirm: (options: MxConfirmOptions) => void;
	 ...
	 */
	showTips: (message: string, callback: (action: MxConfirmAction) => void) => void;

	/**
	 * 显示提示弹窗
	 * @param options MxToastOptions 弹窗配置项
	 */
	showToast: (options: MxToastOptions) => void;
};
